...
H5V_Navigation.prototype = {
    ...
    start: function() {
        ...
        // 0 replace "this.xml[contentsXmlParams.pageViewType]["flag"]"
...
PageManager.prototype = {
    ...
    initialize: function(a) {
        this.isDoublePageMode = a;
        var data_isnull = JSON.stringify(this.data) == "{}";
        this.TotalPageCount = data_isnull ? 1000 :parseInt(this.data[contentsXmlParams.totalPageCount]["pagecount"]);
        this.SamplePageList = "1-"+this.TotalPageCount;//this.data[contentsXmlParams.samplePageList]["list"];
        this.SkipPageList = data_isnull ? null : this.data[contentsXmlParams.skipPageList]["list"];
        this.PageViewType = data_isnull ? null : this.data[contentsXmlParams.pageViewType]["flag"];
        this.ZeroPageFlg = (contentsXmlParams.zeroPageFlag in this.data && "flag"in this.data[contentsXmlParams.zeroPageFlag]) ? this.data[contentsXmlParams.zeroPageFlag]["flag"] : 0;
